...
function ProductList() {
    const dispatch = useDispatch(); // Make sure to use useDispatch for Redux
    ...
    const handleAddToCart = (product) => {
        dispatch(addItem(product)); // Dispatch the action to add item to cart
                                ...
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button 
                                            ...
                                            style={{ backgroundColor: addedToCart[plant.name] ? 'gray' : '#4CAF50', color: '#fff' }} // Gray if added
